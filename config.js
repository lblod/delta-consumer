...
export const TARGET_DATABASE = process.env.DCR_TARGET_DATABASE || 'virtuoso';
export const REMAPPING_DATABASE_ENDPOINT = process.env.DCR_REMAPPING_DATABASE_ENDPOINT || `http://${TARGET_DATABASE}:8890/sparql`;
