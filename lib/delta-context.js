 ...
 * @return {Object} changeSets with context
 *
 */
export async function addContext(changeSets) {
  ...
  let typeCache = new TypeCache(changeSets);
...
export function deleteFromIngestGraph(statements) {
...
export function insertIntoIngestGraph(statements) {
