...
// Copied from https://github.com/lblod/worship-positions-graph-dispatcher-service-loket
...
export function parseSparqlJsonTerm(jsonTerm) {
  ...
  switch (jsonTerm.type) {
    ...
    case "literal":
      ...
      } else if (jsonTerm.lang) {
        parsedTerm = literal(jsonTerm.value, jsonTerm.lang);
