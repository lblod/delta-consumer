...
quickstart-consumer:
  ...
  environment:
    ...
    DCR_SYNC_BASE_URL: 'https://loket.lblod.info' # The host where the delta-files may be found.
    ...
    START_FROM_DELTA_TIMESTAMP: "2023-12-01" # From where it should start syncing in time; left empty it starts from "now".
    DCR_WAIT_FOR_INITIAL_SYNC: "false"
    DCR_DISABLE_INITIAL_SYNC: "true"
```
For more fine grained control, please refer to the rest of the documentation.
